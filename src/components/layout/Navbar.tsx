      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-[10px] shrink-0">
            ...
            <span style={{ color: C.white, fontSize: 12, fontWeight: 600, whiteSpace: "nowrap" }}>
          ...
          <div className="flex items-center gap-[12px] shrink-0">
            <div style={{ width: 1.5, height: 22, background: "rgba(255,255,255,.4)", borderRadius: 2 }} />

            <a href="tel:+918754031480" className="flex items-center gap-[6px]"
              style={{ color: C.white, fontWeight: 600, fontSize: 12, letterSpacing: ".2px", textDecoration: "none" }}>
              <Phone size={12} strokeWidth={2} /> 8754031480
            </a>

            <Link href="/demo">
              <button
                style={{
                  height: 32, minWidth: 120, padding: "0 14px",
            ...
            {/* Google Rating badge */}
            <div style={{
              height: 32, minWidth: 130, background: C.white, borderRadius: 7,
              display: "flex", alignItems: "center", gap: 7,
              padding: "0 10px", boxShadow: "0 4px 12px rgba(0,0,0,.18)",
            }}>
              ...
              <div>
                <p style={{ fontSize: "9px", color: "#5f6368", fontWeight: 500, margin: 0, lineHeight: 1.2 }}>
                  Google Rating
                </p>
                <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#202124" }}>4.9</span>
                  <span style={{ color: "#fbbc04", fontSize: 9, letterSpacing: 1 }}>★★★★★</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          {/* ── VERTICAL DIVIDER ── */}
          <div style={{ width: 2, height: 44, background: "#dbe0ea", borderRadius: 2, margin: "0 18px", flexShrink: 0 }} />

          {/* ── MENU ITEMS ── */}
          <div
            className="flex items-center h-full"
            style={{ flex: 1, justifyContent: "center", gap: "10px", padding: "0 16px 0 4px" }}
          >
              ...
              return (
                ...
                >
                  <Link href={href} style={{ textDecoration: "none" }}>
                    ...
                    >
                      <Icon size={13} style={{ color: active ? C.blue : C.inactive }} />
                      <span style={{
                        ...
                        {hasDropdown && (
                          ...
                          >
                            <ChevronDown size={9} style={{ display: "inline" }} />
                          </motion.span>
                        )}
                      </span>
                      {active && (
                        <div style={{
                          ...
                          width: 28, height: 3, borderRadius: 10, background: C.blue,
                        }} />
                      )}
                    </div>
                  </Link>
